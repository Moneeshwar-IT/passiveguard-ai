...
export default function ModelPerformance() {
  ...
  return (
    <div className="space-y-6 pb-12 font-sans">
      ...
      <div className="bg-[#FFFFFF] border border-[#E2E8F0] border-t-4 border-t-[#4F46E5] p-5 rounded-xl space-y-3 shadow-xs hover:shadow-md transition-all">
      ...
      <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-xl overflow-hidden shadow-xs hover:shadow-md transition-all">
                ...
                {displayList.map((d) => (
                  <tr key={d.name} className="hover:bg-[#F8FAFC] transition-colors">
                    ...
                    <td className="py-3.5 px-4">
                      {d.available ? (
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[#ECFDF5] text-[#16A34A] border border-[#BBF7D0] flex items-center gap-1 w-max">
