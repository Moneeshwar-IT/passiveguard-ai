    ...
    <div className="space-y-6 pb-8 font-sans">
      ...
      <div className="border-b border-[#E2E8F0] pb-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-[#F5F3FF] border border-[#DDD6FE] text-[#7C3AED]">
            CYBER INTELLIGENCE
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white border border-[#E2E8F0] border-t-4 border-t-[#2563EB] p-4 rounded-xl shadow-xs hover:shadow-sm transition-all">
        ...
        <div className="bg-white border border-[#E2E8F0] border-t-4 border-t-[#4F46E5] p-4 rounded-xl shadow-xs hover:shadow-sm transition-all">
          <div className="flex justify-between items-center text-[#64748B] text-xs font-mono mb-2">
        ...
        <div className="bg-white border border-[#E2E8F0] border-t-4 border-t-[#7C3AED] p-4 rounded-xl shadow-xs hover:shadow-sm transition-all">
          <div className="flex justify-between items-center text-[#64748B] text-xs font-mono mb-2">
        ...
        <div className="bg-white border border-[#E2E8F0] border-t-4 border-t-[#16A34A] p-4 rounded-xl shadow-xs hover:shadow-sm transition-all">
          <div className="flex justify-between items-center text-[#64748B] text-xs font-mono mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-white border border-[#E2E8F0] rounded-xl p-5 shadow-xs hover:shadow-sm transition-all space-y-4">
        ...
        <div className="lg:col-span-7 bg-white border border-[#E2E8F0] rounded-xl p-5 shadow-xs hover:shadow-sm transition-all flex flex-col justify-between">
          <h3 className="text-sm font-bold text-[#0F172A] tracking-tight flex items-center gap-2 border-b border-[#E2E8F0] pb-3 uppercase font-mono">
            <Server className="h-4 w-4 text-[#16A34A]" />
