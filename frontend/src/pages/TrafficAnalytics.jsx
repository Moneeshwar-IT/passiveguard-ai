...
import { PieChart, BarChart3, Server, Radio, Activity, ArrowUpRight } from 'lucide-react';
    ...
    <div className="space-y-6 pb-8 font-sans">
      ...
      <div className="border-b border-[#1E293B] pb-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-teal-950 border border-teal-500/30 text-teal-400">
            PASSIVE STREAM
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[#111827] border border-[#1E293B] p-4 rounded-xl shadow-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 bg-[#111827] border border-[#1E293B] rounded-xl p-5 shadow-lg space-y-4">
          <h3 className="text-sm font-bold text-white tracking-tight flex items-center gap-2 border-b border-[#1E293B] pb-3 uppercase font-mono">
          ...
          {traffic && traffic.protocol_distribution ? (
            <div className="space-y-4 font-mono text-xs">
              {Object.entries(traffic.protocol_distribution).map(([proto, count]) => {
                ...
                return (
                  <div key={proto} className="space-y-1.5 bg-[#070B14] p-3 rounded-lg border border-[#1E293B]">
                    ...
                    <div className="w-full bg-[#111827] rounded-full h-2 overflow-hidden border border-[#1E293B]">
                      <div
        ...
        <div className="lg:col-span-7 bg-[#111827] border border-[#1E293B] rounded-xl p-5 shadow-lg flex flex-col justify-between">
          <h3 className="text-sm font-bold text-white tracking-tight flex items-center gap-2 border-b border-[#1E293B] pb-3 uppercase font-mono">
            ...
            {history.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={history}>
                  ...
                  <Area type="monotone" dataKey="tcp_packets" stroke="#06B6D4" strokeWidth={2} fill="#06B6D4" fillOpacity={0.2} name="TCP Packets" />
                  <Area type="monotone" dataKey="udp_packets" stroke="#10B981" strokeWidth={2} fill="#10B981" fillOpacity={0.2} name="UDP Packets" />
                </AreaChart>
              </ResponsiveContainer>
            ) : (
              <div className="h-full flex items-center justify-center text-slate-500 text-xs font-mono border border-dashed border-[#1E293B] rounded-lg">
