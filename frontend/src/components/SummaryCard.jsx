...
export default function SummaryCard({ title, value, subtitle, icon: Icon, color = 'blue', trend }) {
  const colorMap = {
    cyan: {
      ...
      text: 'text-[#2563EB]',
      borderTop: 'border-t-2 border-t-[#2563EB]',
    },
    blue: {
      badge: 'text-[#2563EB] bg-[#EFF6FF] border-[#BFDBFE]',
      text: 'text-[#2563EB]',
    ...
    indigo: {
      ...
      text: 'text-[#4F46E5]',
      borderTop: 'border-t-2 border-t-[#4F46E5]',
    },
    purple: {
      badge: 'text-[#7C3AED] bg-[#F5F3FF] border-[#DDD6FE]',
      text: 'text-[#7C3AED]',
      borderTop: 'border-t-2 border-t-[#7C3AED]',
    },
    red: {
      badge: 'text-[#DC2626] bg-[#FEF2F2] border-[#FECACA]',
      text: 'text-[#DC2626]',
      borderTop: 'border-t-2 border-t-[#DC2626]',
    },
    amber: {
      badge: 'text-[#D97706] bg-[#FEF3C7] border-[#FDE68A]',
      text: 'text-[#D97706]',
      borderTop: 'border-t-2 border-t-[#D97706]',
    },
    green: {
      badge: 'text-[#15803D] bg-[#ECFDF5] border-[#BBF7D0]',
      text: 'text-[#15803D]',
      borderTop: 'border-t-2 border-t-[#16A34A]',
    },
  };
  ...
  return (
    <div className={`bg-[#FFFFFF] border border-[#E2E8F0] ${styleObj.borderTop} rounded-xl p-4 transition-all shadow-xs hover:shadow-sm hover:border-[#CBD5E1] group flex flex-col justify-between`}>
      <div>
      ...
      {subtitle && (
        <div className="text-[11px] font-mono text-[#64748B] mt-2 pt-2 border-t border-[#E2E8F0] flex items-center justify-between">
          <span>{subtitle}</span>
